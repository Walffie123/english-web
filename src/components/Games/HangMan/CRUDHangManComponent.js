...
export default function CRUDHangManComponent(props) {
  ...
  console.log(levelId);
  const saveHangMan = () => {
    console.log("Fill in blank: " + hangMan.word);
    axios
  ...
  const fetchHangMans = async () => {
    await axios
      .get(`${baseUrl}/findAllHangMansByLevel/${levelId.levelid}`)
      .then((response) => {
        console.log(response.data);
  ...
  const updateHangMan = () => {
    axios
      ...
      .then((response) => {
        ...
        setToUpdateHangMan({ question: '', word: '', level: { levelId: '' } });
        setHangManId('');
        fetchHangMans();
      })
      .catch((error) => {
      ...
      <div className={cx('row')}>
                ...
                <tr>
                  ...
                  <td>
                    <input
                      ...
                      value={hangMan.word}
                      onChange={(e) => setHangMan({ ...hangMan, word: e.target.value })}
                    />
                  </td>
                  <td></td>
                  <td>
        ...
        <Modal show={isModalOpen} onHide={handleCloseModal}>
          <Modal.Header closeButton>
            <Modal.Title>Update Question Word</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            ...
            <div className="row">
              ...
              <input
                ...
                type="text"
                id="backHTML"
                value={toUpdateHangMan.word}
                onChange={(e) => setToUpdateHangMan({ ...toUpdateHangMan, word: e.target.value })}
              />
            </div>
          </Modal.Body>
          <Modal.Footer>
